    ...
    >
      <div className="p-6 flex flex-col h-full">
        ...
        <div className="border border-gray-200 rounded-b-4xl flex-1 flex flex-col gap-3">
          ...
          <div className="flex flex-row sm:gap-3 justify-center border-t border-t-gray-200 py-4 text-center">
            <ActionButton
              href={GitHub.url}
              className="py-4 px-3 sm:px-6 bg-black text-gray-200 hover:text-white rounded-xl flex-1 mx-2 text-sm xl:text-lg hover:bg-gray-800"
            >
              {GitHub.text}
            </ActionButton>
            {otherLink.text == null ? null : (
              <ActionButton
                href={otherLink.url}
                className="py-4 px-3 sm:px-6 bg-white text-black border border-gray-300 rounded-xl flex-1 mx-2 text-sm xl:text-lg hover:bg-gray-200"
              >
                {otherLink.text}
              </ActionButton>
            )}
