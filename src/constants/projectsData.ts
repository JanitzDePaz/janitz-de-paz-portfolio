export const projectsData = [
  {
    ...
    tech: [
      { text: "React", img: "src/assets/icon/reactIcon.svg" },
      { text: "TypeScript", img: "src/assets/icon/typeScriptIcon.svg" },
      { text: "NodeJS", img: "src/assets/icon/nodeJSIcon.svg" },
      { text: "Express", img: "src/assets/icon/ExpressIcon.svg" },
      { text: "MongoDB", img: "src/assets/icon/MongoDBIcon.svg" },
    ],
    GitHub: {
      text: "Github",
  ...
  },
  {
    ...
    tech: [
      { text: "React Router", img: "src/assets/icon/reactRouterIcon.svg" },
      { text: "TypeScript", img: "src/assets/icon/typeScriptIcon.svg" },
      { text: "Spring Boot", img: "src/assets/icon/springBootIcon.svg" },
      { text: "PostgreSQL", img: "src/assets/icon/postgreSQLIcon.svg" },
      { text: "Zustand", img: "src/assets/icon/zustandIcon.svg" },
      { text: "GSAP", img: "src/assets/icon/gsapIcon.svg" },
      { text: "Vercel", img: "src/assets/icon/vercelIcon.svg" },
      { text: "Render", img: "src/assets/icon/renderIcon.svg" },
      { text: "Neon", img: "src/assets/icon/neonIcon.svg" },
    ],
    GitHub: {
      text: "Github",
